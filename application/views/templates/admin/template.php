...
<head>
    ...
    <title>ENHATECH Admin Panel</title>
    <!-- Icons-->
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                    aria-expanded="false">
                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/6.jpg"
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('adminpanel/forms');?>">
                    ...
                    <div class="list-group list-group-accent">
                        ...
                        <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                            <div class="avatar float-right">
                                <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/7.jpg"
                                    alt="admin@bootstrapmaster.com">
                            </div>
                            <div>Meeting with
                                <strong>Lucas</strong>
                        ...
                        <div class="list-group-item list-group-item-accent-info">
                            <div class="avatar float-right">
                                <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/4.jpg"
                                    alt="admin@bootstrapmaster.com">
                            </div>
                            <div>Skype with
                                <strong>Megan</strong>
                        ...
                        <div class="list-group-item list-group-item-accent-danger list-group-item-divider">
                            ...
                            <div class="avatars-stack mt-2">
                                <div class="avatar avatar-xs">
                                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/2.jpg"
                                        alt="admin@bootstrapmaster.com">
                                </div>
                                <div class="avatar avatar-xs">
                                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/3.jpg"
                                        alt="admin@bootstrapmaster.com">
                                </div>
                                <div class="avatar avatar-xs">
                                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/4.jpg"
                                ...
                                <div class="avatar avatar-xs">
                                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/5.jpg"
                                        alt="admin@bootstrapmaster.com">
                                </div>
                                <div class="avatar avatar-xs">
                                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/6.jpg"
                        ...
                        <div class="list-group-item list-group-item-accent-primary list-group-item-divider">
                            ...
                            <div class="avatars-stack mt-2">
                                ...
                                <div class="avatar avatar-xs">
                                    <img class="img-avatar" src="<?php echo base_url();?>assets/admin/img/avatars/8.jpg"
                                        alt="admin@bootstrapmaster.com">
                                </div>
                            </div>
                        </div>
