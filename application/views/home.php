...
<body>
    ...
    <div class="section-home" id="section-home">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
            ...
            <div class="top-header">
                <a href="#section-home" class="navbar-brand ml-3 mt-2">
                    <img src="assets/img/logo-enha2.png" class="ml-15 mr-2" width="49" height="49">
                    <div class="nav-text">
        ...
        <section class="carousel-atas" id="carousel-atas">
        ...
        <section class="profil" id="section-profil">
            <div class="container profil-container p-3">
                ...
                <div class="row mt-4">
                    <div class="col-md-5 ">
                        <img src="assets/img/yapinda.jpg" alt="profil enha">
                    </div>
            ...
            <div class="container mt-3 sejarah-container p-3">
                ...
                <div class="row">
                    <div class="col-md m-auto text-center">
                        <img src="assets/img/kamad.jpg" alt="H. Enan Suryana Alm">
                    </div>
            ...
            <div class="container gallery-container mt-3">
                ...
                <div class="tz-gallery">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <a class="lightbox" href="assets/img/9.jpg">
        ...
        <!-- <section class="alumni" id="section-alumni">
        <div class="container alumni-container">
            <div class="row justify-content-center">
                <div class="title mb-4 mt-4">
                    <h3 class="title-section mb-1">Alumni Kami</h3>
                    <hr class="hr-section">
                </div>
            </div>
            <div class="isi-card">
                ...
                <div class="row">
                    <div class="col-md">
                        <div class="logo-footer justify-content-center text-center">
                            <img class="mb-2" src="assets/img/logo-enha2.png" alt="footer mas nurul huda">
    ...
    <script src="assets/js/enha.js"></script>
    <script async defer
