<main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Input Informasi</li>
            <!-- Breadcrumb Menu-->
                            ...
                            <tbody class="align-middle" style="height: 100px;">
                                ...
                                <tr valign="middle">
                                    ...
                                    <td class="td-actions text-center align-middle">
                                        <a href="javascript:;" 
                                        data-id="<?php echo $item['id_info']?>" 
                                        data-judul="<?php echo $item['judul_info']?>" 
                                        data-isi="<?php echo $item['isi_info'] ?>" 
                                        data-tgl="<?php echo $item['tgl_info'] ?>" 
                                        data-foto="<?php echo $item['gbr_info'] ?>" 
                                        class="btn btn-info"
                                            type="button" data-toggle="modal" data-target="#edit-modal"><i
                                                class="fa fa-edit"></i></a>
                                        <button
                                            href="<?php base_url()?>deleteinfo/<?php echo $item['id_info'];?>"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="tglinfo" name="tglinfo" required>
                            <!-- <div class="invalid-feedback">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" class="form-control" id="edit_id" name="edit_id_info"
                            value="<?= $item['id_info']?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="edittgl">Tanggal Posting Informasi</label>
                            <input type="datetime-local" class="form-control" id="edittgl" name="edittgl" value="<?=$item['tgl_info']?>" required>
                            <!-- <div class="invalid-feedback">
                                Inputkan Tanggal Posting Informasi!
                            </div> -->
                        </div>
                        ...
                        <div class="custom-file mb-3">
                            <input type="file" class="form-control" id="editgbrinfo" name="editgbrinfo" value="<?=$item['gbr_info']?>">
    ...
    $(document).ready(function() {
            ...
            $('#edit-modal').on('show.bs.modal', function (event) {
                ...
                modal.find('#edittgl').attr("value",div.data('tgl'));
