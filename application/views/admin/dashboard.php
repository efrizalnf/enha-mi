			                                ...
			                                <tbody>
			                                    <tr>
			                                        <td class="text-center">
			                                            <div class="avatar">
			                                                <img src="<?php echo base_url();?>assets/img/avatars/1.jpg"
			                                    ...
			                                    <tr>
			                                        <td class="text-center">
			                                            <div class="avatar">
			                                                <img src="<?php echo base_url();?>assets/admin/img/avatars/2.jpg"
			                                                    class="img-avatar" alt="admin@bootstrapmaster.com">
			                                    ...
			                                    <tr>
			                                        <td class="text-center">
			                                            <div class="avatar">
			                                                <img src="<?php echo base_url();?>assets/admin/img/avatars/3.jpg"
			                                                    class="img-avatar" alt="admin@bootstrapmaster.com">
			                                    ...
			                                    <tr>
			                                        <td class="text-center">
			                                            <div class="avatar">
			                                                <img src="<?php echo base_url();?>assets/admin/img/avatars/4.jpg"
			                                                    class="img-avatar" alt="admin@bootstrapmaster.com">
			                                    ...
			                                    <tr>
			                                        <td class="text-center">
			                                            <div class="avatar">
			                                                <img src="<?php echo base_url();?>assets/admin/img/avatars/5.jpg"
			                                                    class="img-avatar" alt="admin@bootstrapmaster.com">
			                                                <span class="avatar-status badge-success"></span>
			                                            </div>
			                                        </td>
			                                    ...
			                                    <tr>
			                                        <td class="text-center">
			                                            <div class="avatar">
			                                                <img src="<?php echo base_url();?>assets/admin/img/avatars/6.jpg"
			                                                    class="img-avatar" alt="admin@bootstrapmaster.com">
			                                                <span class="avatar-status badge-danger"></span>
			                                            </div>
			                                        </td>
